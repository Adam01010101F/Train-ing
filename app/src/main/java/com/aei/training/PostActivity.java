...
//        fStore.collection("Post").document(String.valueOf
    ...
    public void instaFire() {
        ...
        if(fUser.getDisplayName().equals(null) || fUser.getDisplayName().equals("")){
            Intent intent = new Intent(PostActivity.this, EditDisplayInfo.class);
            startActivity(intent);
        }
