...
public class createThreadTest {
    ...
    public void createThreadTest() {
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.passField), withText("1"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withText("Metro Blue Line (801) General"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.ScrollView")),
                                        0),
        ...
        ViewInteraction floatingActionButton = onView(
                allOf(withId(R.id.AddPost),
                        childAtPosition(
                                allOf(withId(R.id.const_layout),
                                        childAtPosition(
                                                withId(R.id.act_thread),
                                                1)),
                                0),
                        isDisplayed()));
        ...
        ViewInteraction editText2 = onView(
                allOf(childAtPosition(
                        ...
                        0),
                        isDisplayed()));
        editText2.perform(replaceText("Training "), closeSoftKeyboard());
