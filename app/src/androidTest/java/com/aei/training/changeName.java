...
public class changeName {
    ...
    public void changeName() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.emailField),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("israelgrogin@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.passField), withText("12345678"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.uNameField),
                        childAtPosition(
                                allOf(withId(R.id.acc_edit_layout),
                                        childAtPosition(
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.uNameField),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("Kstlr"), closeSoftKeyboard());

        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.uNameField), withText("Kstlr"),
                        childAtPosition(
                                allOf(withId(R.id.acc_edit_layout),
                                        childAtPosition(
                                                withClassName(is("android.widget.LinearLayout")),
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.submitDisplayInfo), withText("Submit"),
                        childAtPosition(
                                allOf(withId(R.id.acc_edit_layout),
                                        childAtPosition(
                                                withClassName(is("android.widget.LinearLayout")),
